...
export const mockPets = [
  {
    ...
    weight: 60,
    age: 5,
    photo: "/images/gallery/bijcher.jpg",
    notes: "Scared of getting nails clipped!",
    vaccineStatus: {
      rabies: { status: "current", expiresAt: "2026-11-15" },
      bordetella: { status: "current", expiresAt: "2026-09-20" },
      dhpp: { status: "current", expiresAt: "2026-10-05" },
    },
  },
];
...
export const mockTestimonials = [
  ...
  },
  {
    ...
    content:
      "The team was amazing with Bella! She came out looking absolutely beautiful and seemed so relaxed. Will definitely be back!",
    date: "2024-12-20",
    groomer: "Austin",
    verified: true,
  },
  {
    ...
    content:
      "Ivan is a true professional. Charlie looks fantastic and you can tell he had a positive experience.",
    date: "2024-12-15",
    groomer: "Ivan",
    verified: true,
  },
...
export const mockServices = [
  {
    ...
    description:
      "Complete grooming including bath, haircut, nail trim, ear cleaning, and teeth brushing",
    duration: "90-120 min",
    priceRange: "$75-$120",
    popular: true,
  },
  ...
  },
  {
    ...
    name: "Nail Trim",
    description:
      "Professional nail trimming and filing with extra care for nervous pets",
    duration: "15-20 min",
    priceRange: "$20-$25",
    popular: false,
  },
  {
    ...
    description:
      "Special treatment to remove loose undercoat and reduce shedding",
    duration: "60 min",
    priceRange: "$60-$85",
    popular: true,
  },
